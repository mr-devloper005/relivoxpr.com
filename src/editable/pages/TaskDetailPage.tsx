    ...
    <section className="bg-[var(--slot4-page-bg)]">
      ...
      {images[0] ? (
        <figure className="mx-auto -mt-8 w-full max-w-[1100px] px-4 sm:px-6 lg:px-8">
          <div className="signal-zoom overflow-hidden rounded-3xl border border-[var(--editable-border)] bg-white shadow-[0_30px_80px_rgba(26,26,15,0.16)]">
  ...
  return (
    <section className="mx-auto max-w-[var(--editable-container)] px-4 py-10 sm:px-6 lg:px-8 lg:py-16">
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-[minmax(0,1fr)_420px]">
        <article className="rounded-[2.8rem] border border-[var(--editable-border)] bg-white p-6 shadow-[0_30px_90px_rgba(26,26,15,0.09)] sm:p-9">
...
function ClassifiedDetail({ post, related }: { post: SitePost; related: SitePost[] }) {
  ...
  return (
    <section className="mx-auto grid max-w-[var(--editable-container)] gap-7 px-4 py-10 sm:px-6 lg:grid-cols-[0.82fr_1.18fr] lg:px-8 lg:py-16">
      ...
      <article className="rounded-[2.7rem] border border-[var(--editable-border)] bg-white p-6 shadow-[0_30px_90px_rgba(26,26,15,0.08)] sm:p-9">
...
function BookmarkDetail({ post, related }: { post: SitePost; related: SitePost[] }) {
  ...
  return (
    <section className="mx-auto grid max-w-[var(--editable-container)] gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[minmax(0,1fr)_360px] lg:px-8 lg:py-16">
      <article className="rounded-[2.7rem] border border-[var(--editable-border)] bg-white p-7 shadow-[0_30px_90px_rgba(26,26,15,0.08)] sm:p-10">
        <BackLink task="sbm" />
...
function ProfileDetail({ post, related }: { post: SitePost; related: SitePost[] }) {
  ...
  return (
    <section className="mx-auto grid max-w-[var(--editable-container)] gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[420px_minmax(0,1fr)] lg:px-8 lg:py-16">
      <aside className="rounded-[2.7rem] border border-[var(--editable-border)] bg-white p-8 text-center shadow-[0_30px_90px_rgba(26,26,15,0.08)] lg:sticky lg:top-24 lg:self-start">
...
function RelatedPanel({ task, related, compact = false }: { task: TaskKey; post: SitePost; related: SitePost[]; compact?: boolean }) {
  ...
  return (
    <aside className="min-w-0 space-y-5 lg:sticky lg:top-24">
      {!compact ? (
        <div className="rounded-3xl border border-[var(--editable-border)] bg-[var(--detail-surface)] p-6 shadow-[0_14px_40px_rgba(26,26,15,0.08)]">
...
function EditableComments({ comments }: { slug: string; comments: Array<{ id: string; name: string; comment: string; createdAt: string }> }) {
  return (
    <section className="mt-12 rounded-3xl border border-[var(--editable-border)] bg-[var(--detail-surface)] p-6 shadow-[0_14px_40px_rgba(26,26,15,0.08)]">
