...
const buttonClass = 'inline-flex h-[3.25rem] items-center justify-center rounded-full bg-[var(--slot4-accent)] px-6 text-sm font-bold tracking-[0.02em] text-white shadow-[0_12px_30px_rgba(13,25,145,0.28)] transition hover:-translate-y-0.5 hover:bg-[var(--slot4-accent-strong)] disabled:opacity-60'
